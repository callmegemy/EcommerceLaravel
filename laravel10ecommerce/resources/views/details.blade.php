                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="details-image-vertical black-slide rounded">
                                        <div>
                                            <img src="{{asset('assets/images/fashion/product/front')}}/{{$product->image}}" class="img-fluid  lazyload" alt="{{$product->name}}">
                                        </div>
                                        @if($product->images) 
                                        @php 
                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        ...
                                        @foreach ($images as $image)
                                            <div>
                                                <img src="{{asset('assets/images/fashion/product/front')}}/{{$image}}" class="img-fluid w-100 image_zoom_cls-1  lazyload" alt="{{$product->name}}">
                                            </div>                                            
                                        @endforeach 
                                        @endif                                                                                  
                                    </div>
