...
<head>
    ...
    <script src="https://kit.fontawesome.com/88b712c586.js" crossorigin="anonymous"></script>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{route('index')}}" style="color:orange;font-weight:bolder;">
                                       Gemex
                                    </a>
                                </div>
                                ...
                                <ul>
                                    ...
                                    <li class="onhover-dropdown">
                                        <div class="cart-media name-usr">
                                            @auth <span>{{Auth::User()->name}}</span> @endauth  <i class="fa-solid fa-user"></i>
                                        </div>
                ...
                <div class="row gy-4">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" style="color:navy;font-weight:bold;" class="footer-logo float-start">
                                   Gemex
                                </a>
                            </div>
